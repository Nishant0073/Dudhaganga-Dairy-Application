...
Widget viewAllRecordsScreen(
    BuildContext context, ViewHistoryModelFarmer model) {
  return Scaffold(
    appBar: AppBar(
...
getRowsBuyer(ViewHistoryModelFarmer model) {
...
getRowsFarmer(ViewHistoryModelFarmer model) {
  List<TableRow> rows = [
    TableRow(
        decoration: BoxDecoration(color: Color.fromARGB(255, 185, 181, 181)),
        children: const [
